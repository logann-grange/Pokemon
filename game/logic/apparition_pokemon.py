...
def apparition_pokemon():
    ...
    if niv < 25:
        ...
        pokemon_level=random.randint(max(5, niv-5), niv+5)  # Niveau aléatoire autour du niveau du joueur
    elif niv < 50:
        ...
        pokemon_level=random.randint(max(5, niv-10), niv+10)  # Niveau aléatoire autour du niveau du joueur
    else:
        possible_pokemon = [pokemon for pokemon in pokedex_data if pokemon["hidden"]==True]
        pokemon_level=random.randint(max(5, niv-15), niv+15)  # Niveau aléatoire autour du niveau du joueur
