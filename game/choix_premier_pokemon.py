...
class MenuChoixPokemon:
    def __init__(self):
        ...
        self.screen = get_screen("Pokemon")
        self.background = pygame.image.load(os.path.join(self.project_root, "Asset", "Professor", "lab_background.jfif"))
        ...
        self.professeur_chen = pygame.image.load(os.path.join(self.project_root, "Asset", "Professor", "Professor_Oak.png"))
        self.professeur_chen = pygame.transform.scale(self.professeur_chen, (250, 300))
        self.dialogue_box=pygame.image.load(os.path.join(self.project_root, "Asset", "Professor", "dialogue_box.png"))
        self.dialogue_box=pygame.transform.scale(self.dialogue_box, (1080, 200))
        self.music = pygame.mixer.Sound(os.path.join(self.project_root, "Asset", "Professor", "professor_theme.mp3"))
    ...
    def dialogue_professeur_chen(self):
        font_path = os.path.join(self.project_root, "Asset", "menue", "Pixeled.ttf")
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    for i, pokemon in enumerate(self.pokemon_starter):
                        image_path = os.path.join(self.project_root, "Asset", "front", f"{int(pokemon.id)}.png")
