...
def open_pc(pc, screen) : 
    ...
    pc.pokemon = pc.load_pokemon_list("equipe")
    pc.displayed_pokemon = pc.searching()
    pc.team = pc.refresh_team()
    pc.num_unlock = pc.get_num_unlock()
    pc.selected_pokemon = None
    pc.page = 1
    pc.search = ""
    ...
    pc_background = pygame.image.load("Asset/pc.jpg")
    list_rect = []
    index_info = None
    is_info = False
    page_info = 1
